...
// Use METRO_PORT if set; fall back to PORT; default to a port unlikely to collide with
// other workspace services (which run on 8080/8081/18115).
const METRO_PORT = parseInt(process.env.METRO_PORT || process.env.PORT || '19001', 10);
